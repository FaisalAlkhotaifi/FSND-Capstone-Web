...
export class AuthService {
  ...
  isCastingAssistant() {
    return this.can('get:actors') &&
           this.can('get:categories') &&
           this.can('get:movies')
  }

  isCastingDirector() {
    return this.isCastingAssistant() &&
           this.can('add:actor') &&
           this.can('delete:actor') &&
           this.can('update:actor') &&
           this.can('update:movie')
  }
  
  isExecutiveProducer() {
    return this.isCastingDirector() &&
           this.can('add:category') &&
           this.can('add:movie') &&
           this.can('delete:category') &&
           this.can('delete:movie') &&
